...
def gridsearch_report_by_class(classifier, X, y,
                                   cv = None,
                                   score = 'f1',
                                   classes_names = None,
                                   parameters = None,
    ...
    o GridSearch com todo o dataset. Em seguida o classificador
    ...
    grid = GridSearchCV(classifier, parameters, cv = cv, scoring = score, n_jobs = jobs)
    grid.fit(X, y)
    print "Done!!"
